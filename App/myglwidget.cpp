...
// Declaration variables caméra
float cameraX = -2.5f; // Position initiale de la caméra
float cameraSpeed = 0.05f; // Vitesse camera
...
void MyGLWidget::drawTerrainDroiteBackground(int terrainIndex) {
    ...
    // Définir les coordonnées de texture pour chaque sommet
    glBegin(GL_QUADS);
    glTexCoord2f(1.0f, 1.0f); glVertex3f(0.0f, 0.0f, -5.0f);  // Bas gauche
    glTexCoord2f(0.0f, 1.0f); glVertex3f(5.0f, 0.0f, -5.0f);    // Bas droit
    glTexCoord2f(0.0f, 0.0f); glVertex3f(5.0f, 5.0f, -5.0f);    // Haut droit
    glTexCoord2f(1.0f, 0.0f); glVertex3f(0.0f, 5.0f, -5.0f);   // Haut gauche
    glEnd();
...
void MyGLWidget::drawSaladier() {
    ...
    GLUquadric* quadricSaladier = gluNewQuadric();
    gluQuadricDrawStyle(quadricSaladier, GLU_FILL);
    glRotatef(-90.0f, 1.0f, 0.0f, 0.0f);
    gluCylinder(quadricSaladier, 0, 0.87, 0.2, 20, 20);
    glTranslatef(0.0f, 0.0f, 0.2f);
    gluCylinder(quadricSaladier, 0.87, 1.2, 0.2, 20, 20);
    glTranslatef(0.0f, 0.0f, 0.2f);
    gluCylinder(quadricSaladier, 1.2, 1.43, 0.2, 20, 20);
    glTranslatef(0.0f, 0.0f, 0.2f);
    gluCylinder(quadricSaladier, 1.43, 1.6, 0.2, 20, 20);
    glTranslatef(0.0f, 0.0f, 0.2f);
    gluCylinder(quadricSaladier, 1.6, 1.73, 0.2, 20, 20);
    glTranslatef(0.0f, 0.0f, 0.2f);
    gluCylinder(quadricSaladier, 1.73, 1.83, 0.2, 20, 20);
    glTranslatef(0.0f, 0.0f, 0.2f);
    gluCylinder(quadricSaladier, 1.83, 1.91, 0.2, 20, 20);
    glTranslatef(0.0f, 0.0f, 0.2f);
    gluCylinder(quadricSaladier, 1.91, 1.96, 0.2, 20, 20);
    glTranslatef(0.0f, 0.0f, 0.2f);
    gluCylinder(quadricSaladier, 1.96, 1.99, 0.2, 20, 20);
    glTranslatef(0.0f, 0.0f, 0.2f);
    gluCylinder(quadricSaladier, 1.99, 2, 0.2, 20, 20);
    gluDeleteQuadric(quadricSaladier);
    glPopMatrix();
}
